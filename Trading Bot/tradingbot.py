...
API_KEY = "PK7IHAM3I0MFVSW74AH9"
API_SECRET = "SgEyc21SQpIVq8cgyn8jkyqhzIaFIYzeK6nC1C6c"
...
# If we want to deploy it we basically uncomment the following lines below and comment out the backtest
